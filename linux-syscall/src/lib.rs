...
impl Syscall<'_> {
    ...
    pub async fn syscall(&mut self, num: u32, args: [usize; 6]) -> isize {
        ...
        let ret = match sys_type {
            ...
            Sys::SETGID => self.unimplemented("setgid", Ok(0)),
            Sys::SETREUID => self.unimplemented("setreuid", Ok(0)),
            Sys::SETREGID => self.unimplemented("setregid", Ok(0)),
            Sys::SETRESUID => self.unimplemented("setresuid", Ok(0)),
            Sys::SETRESGID => self.unimplemented("setresgid", Ok(0)),
