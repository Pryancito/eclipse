...
impl UefiConfigManager {
    ...
    pub fn create_uefi_config(&self, mount_point: &str) -> Result<(), String> {
        let config_content = r#"# Configuración UEFI para Eclipse OS v0.2.0
...
[eclipse-recovery]
title = "Eclipse OS v0.2.0 (Recovery)"
...
"#;
    ...
    pub fn create_module_config(&self, mount_point: &str) -> Result<(), String> {
        let module_config_content = r#"# Configuración de módulos para Eclipse OS v0.2.0
# ================================================
