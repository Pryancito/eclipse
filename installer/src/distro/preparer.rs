...
impl DistroPreparer {
    ...
    fn copy_binaries(&self) -> Result<()> {
        let binaries = vec![
            ...
            ("../eclipse_kernel/userspace/init/target/x86_64-unknown-linux-musl/release/eclipse-init", "sbin/eclipse-init"),
            // Servicios de userspace (cargados desde /sbin por el kernel/init)
            ("../eclipse_kernel/userspace/log_service/target/x86_64-unknown-linux-musl/release/log_service", "sbin/log_service"),
            ("../eclipse_kernel/userspace/devfs_service/target/x86_64-unknown-linux-musl/release/devfs_service", "sbin/devfs_service"),
            ("../eclipse_kernel/userspace/filesystem_service/target/x86_64-unknown-linux-musl/release/filesystem_service", "sbin/filesystem_service"),
            ("../eclipse_kernel/userspace/input_service/target/x86_64-unknown-linux-musl/release/input_service", "sbin/input_service"),
            ("../eclipse_kernel/userspace/display_service/target/x86_64-unknown-linux-musl/release/display_service", "sbin/display_service"),
            ("../eclipse_kernel/userspace/audio_service/target/x86_64-unknown-linux-musl/release/audio_service", "sbin/audio_service"),
            ("../eclipse_kernel/userspace/network_service/target/x86_64-unknown-linux-musl/release/network_service", "sbin/network_service"),
            ("../eclipse_kernel/userspace/gui_service/target/x86_64-unknown-linux-musl/release/gui_service", "sbin/gui_service"),
