...
#define GNULIB_ACCEPT IN_GETTEXT_TOOLS_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module bind shall be considered present. */
#define GNULIB_BIND IN_GETTEXT_TOOLS_GNULIB_TESTS
...
#define GNULIB_CONNECT IN_GETTEXT_TOOLS_GNULIB_TESTS
...
#define GNULIB_IOCTL IN_GETTEXT_TOOLS_GNULIB_TESTS
...
#define GNULIB_LISTEN IN_GETTEXT_TOOLS_GNULIB_TESTS
...
#define GNULIB_SELECT IN_GETTEXT_TOOLS_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module setsockopt shall be considered present. */
#define GNULIB_SETSOCKOPT IN_GETTEXT_TOOLS_GNULIB_TESTS
...
#define GNULIB_SOCKET IN_GETTEXT_TOOLS_GNULIB_TESTS
...
/* Define to 1 when the gnulib module isnan-no-cxx should be tested. */
#define GNULIB_TEST_ISNAN_NO_CXX 1
...
#define GNULIB_XSTRING_BUFFER 1

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module xstring-buffer-reversed shall be considered
   present. */
#define GNULIB_XSTRING_BUFFER_REVERSED 1
