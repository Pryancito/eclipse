...
pub const SYS_MOUNT_LINUX:      usize = 165; // Linux mount(2) — not implemented in Eclipse
...
pub const SYS_SIGNALFD:         usize = 282; // signalfd4 in Eclipse
pub const SYS_SIGNALFD4:        usize = 282;
...
pub const SYS_MOUNT:            usize = 510; // Eclipse native: mount disk device as root
pub const SYS_ECLIPSE_MOUNT:    usize = 510; // Alias for SYS_MOUNT
...
pub const SYS_SCHED_SETAFFINITY_ECLIPSE: usize = 533;
...
/// Obtener los argumentos del proceso actual.
pub const SYS_GET_PROCESS_ARGS: usize = 543;
/// Spawn como SYS_SPAWN_WITH_STDIO pero el ELF se lee en el kernel desde la ruta.
...
/// Use SYS_EXECVE (59) for the Linux-compatible path/argv/envp variant.
