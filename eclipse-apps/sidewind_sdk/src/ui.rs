...
mod tests {
    ...
    #[test]
    fn test_colors_white() {
        assert_eq!(colors::WHITE.r(), 255);
        assert_eq!(colors::WHITE.g(), 255);
        assert_eq!(colors::WHITE.b(), 255);
    }

    #[test]
    fn test_colors_accent_blue() {
        assert_eq!(colors::ACCENT_BLUE.r(), 100);
        assert_eq!(colors::ACCENT_BLUE.g(), 230);
        assert_eq!(colors::ACCENT_BLUE.b(), 255);
    }

    #[test]
    fn test_colors_cosmic_deep() {
        assert_eq!(colors::COSMIC_DEEP.r(), 2);
        assert_eq!(colors::COSMIC_DEEP.g(), 2);
        assert_eq!(colors::COSMIC_DEEP.b(), 8);
    }

    #[test]
    fn test_colors_distinct() {
        assert_ne!(colors::WHITE, colors::ACCENT_BLUE);
        assert_ne!(colors::ACCENT_RED, colors::ACCENT_GREEN);
    }

    #[test]
    fn test_icon_sizes() {
        assert_eq!(super::STANDARD_ICON_SIZE, 64);
        assert_eq!(super::BUTTON_ICON_SIZE, 20);
    }

    /// Stress: lecturas repetidas de colores e icon sizes.
    #[test]
    fn test_stress_colors_and_icons() {
        ...
        for i in 0..ITERS {
            ...
            let _ = (c.r(), c.g(), c.b());
            let _ = super::STANDARD_ICON_SIZE + super::BUTTON_ICON_SIZE;
        }
    }
}
