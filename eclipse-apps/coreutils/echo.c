...
void _start(int argc, char *argv[]) {
    // echo imprime todos sus argumentos separados por espacio
    
    // Por ahora, imprimir mensaje simple
    // TODO: Parsear argc/argv cuando execve() los pase
    
    write_str("Hello from Eclipse OS\n");
    sys_exit(0);
}
