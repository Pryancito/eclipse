...
impl TcpHeader {
    ...
    pub fn new(source_port: TcpPort, dest_port: TcpPort, sequence: u32, ack_sequence: u32, flags: TcpFlags) -> Self {
        Self {
            source_port,
            dest_port,
            sequence,
...
impl TcpSegment {
    ...
    pub fn new(source_port: TcpPort, dest_port: TcpPort, sequence: u32, ack_sequence: u32, flags: TcpFlags, payload: Vec<u8>) -> Self {
...
impl TcpConnection {
    ...
    pub fn process_segment(&mut self, segment: &TcpSegment) -> Result<Option<TcpSegment>, NetworkError> {
