...
impl Terminal {
    ...
    fn register_builtin_commands(&mut self) {
        // Comando help
        self.commands.insert("help".to_string(), Command {
            name: "help".to_string(),
        ...
        // Comando ls
        self.commands.insert("ls".to_string(), Command {
            name: "ls".to_string(),
        ...
        // Comando pwd
        self.commands.insert("pwd".to_string(), Command {
            name: "pwd".to_string(),
        ...
        // Comando cd
        self.commands.insert("cd".to_string(), Command {
            name: "cd".to_string(),
        ...
        // Comando cat
        self.commands.insert("cat".to_string(), Command {
            name: "cat".to_string(),
        ...
        // Comando calc
        self.commands.insert("calc".to_string(), Command {
            name: "calc".to_string(),
        ...
        // Comando history
        self.commands.insert("history".to_string(), Command {
        ...
        // Comando clear
        self.commands.insert("clear".to_string(), Command {
        ...
        // Comando echo
        self.commands.insert("echo".to_string(), Command {
            name: "echo".to_string(),
        ...
        // Comando date
        self.commands.insert("date".to_string(), Command {
            name: "date".to_string(),
    ...
    fn setup_environment(&mut self) {
        ...
        self.environment.insert("HOME".to_string(), "/home/eclipse".to_string());
    ...
    fn cmd_cd(terminal: &mut Terminal, args: &[String]) -> Result<(), String> {
        ...
        terminal.environment.insert("PWD".to_string(), terminal.working_directory.clone());
        Ok(())
    }
    ...
    fn evaluate_math_expression(expr: &str) -> Result<f64, String> {
        ...
        if let Some(pos) = expr.find('+') {
            ...
            let right = expr[pos+1..].parse::<f64>().map_err(|_| "Número inválido")?;
        ...
        expr.parse::<f64>().map_err(|_| "Expresión no válida".to_string())
    }
