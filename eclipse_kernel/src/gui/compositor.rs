...
use crate::gui::framebuffer::{get_framebuffer, Color, Point, Rect};
...
impl Compositor {
    ...
    fn render_windows(
        &self,
        framebuffer: &mut crate::gui::framebuffer::Framebuffer,
        window_manager: &crate::gui::window::WindowManager,
    ) {
    ...
    pub fn update_cursor_position(&mut self, position: Point) {
        ...
        let cursor_rect = Rect::new(position.x - 2, position.y - 2, 16, 16);
