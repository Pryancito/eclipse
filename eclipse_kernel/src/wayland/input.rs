    ...
    pub fn new(device_type: InputDeviceType) -> Self {
        let (name, capabilities) = match device_type {
            InputDeviceType::Keyboard => {
                ("Eclipse Keyboard".to_string(), InputCapabilities::KEYBOARD)
            }
            InputDeviceType::Mouse => ("Eclipse Mouse".to_string(), InputCapabilities::POINTER),
            InputDeviceType::Touch => ("Eclipse Touch".to_string(), InputCapabilities::TOUCH),
        };
