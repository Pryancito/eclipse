...
use crate::drivers::amd_graphics::{AmdDriverState, AmdGraphicsDriver};
use crate::drivers::intel_graphics::{IntelDriverState, IntelGraphicsDriver};
...
static FONT_DATA: [(char, [u8; 8]); 95] = [
    ...
    (
        'I',
        [
            0b00111100, 0b00010000, 0b00010000, 0b00010000, 0b00010000, 0b00010000, 0b00111100,
            0b00000000,
        ],
    ),
    (
        'J',
        [
            0b00011110, 0b00000100, 0b00000100, 0b00000100, 0b01000100, 0b01000100, 0b00111000,
            0b00000000,
        ],
    ),
    (
    ...
    (
        'S',
        [
            0b00111100, 0b01000010, 0b01000000, 0b00111100, 0b00000010, 0b01000010, 0b00111100,
            0b00000000,
        ],
    ),
    (
    ...
    (
        'Y',
        [
            0b01000010, 0b00100100, 0b00011000, 0b00010000, 0b00010000, 0b00010000, 0b00010000,
            0b00000000,
        ],
    ),
    (
        'Z',
        [
            0b01111110, 0b00000010, 0b00000100, 0b00001000, 0b00010000, 0b00100000, 0b01111110,
            0b00000000,
        ],
    ),
    (
        'a',
        [
            0b00000000, 0b00111000, 0b00000100, 0b00111100, 0b01000100, 0b01000100, 0b00111100,
            0b00000000,
        ],
    ),
    (
    ...
    (
        'c',
        [
            0b00000000, 0b00111100, 0b01000000, 0b01000000, 0b01000000, 0b01000000, 0b00111100,
            0b00000000,
        ],
    ),
    (
    ...
    (
        'e',
        [
            0b00000000, 0b00111000, 0b01000100, 0b01111100, 0b01000000, 0b01000000, 0b00111100,
            0b00000000,
        ],
    ),
    (
        'f',
        [
            0b00011100, 0b00100000, 0b00100000, 0b01110000, 0b00100000, 0b00100000, 0b00100000,
            0b00000000,
        ],
    ),
    (
        'g',
        [
            0b00000000, 0b00111100, 0b01000100, 0b01000100, 0b00111100, 0b00000100, 0b00111000,
            0b00000000,
        ],
    ),
    (
    ...
    (
        'j',
        [
            0b00001000, 0b00000000, 0b00011000, 0b00001000, 0b00001000, 0b01001000, 0b00110000,
            0b00000000,
        ],
    ),
    (
        'k',
        [
            0b01000000, 0b01001000, 0b01010000, 0b01100000, 0b01010000, 0b01001000, 0b01000100,
            0b00000000,
        ],
    ),
    (
    ...
    (
        'm',
        [
            0b00000000, 0b01101100, 0b01010100, 0b01010100, 0b01010100, 0b01010100, 0b01010100,
            0b00000000,
        ],
    ),
    (
        'n',
        [
            0b00000000, 0b01111000, 0b01000100, 0b01000100, 0b01000100, 0b01000100, 0b01000100,
            0b00000000,
        ],
    ),
    (
        'o',
        [
            0b00000000, 0b00111000, 0b01000100, 0b01000100, 0b01000100, 0b01000100, 0b00111000,
            0b00000000,
        ],
    ),
    (
        'p',
        [
            0b00000000, 0b01111000, 0b01000100, 0b01000100, 0b01111000, 0b01000000, 0b01000000,
            0b00000000,
        ],
    ),
    (
        'q',
        [
            0b00000000, 0b00111100, 0b01000100, 0b01000100, 0b00111100, 0b00000100, 0b00000100,
            0b00000000,
        ],
    ),
    (
        'r',
        [
            0b00000000, 0b01011000, 0b01100100, 0b01000000, 0b01000000, 0b01000000, 0b01000000,
            0b00000000,
        ],
    ),
    (
        's',
        [
            0b00000000, 0b00111100, 0b01000000, 0b00111000, 0b00000100, 0b01000100, 0b00111000,
            0b00000000,
        ],
    ),
    (
        't',
        [
            0b00100000, 0b01110000, 0b00100000, 0b00100000, 0b00100000, 0b00100000, 0b00011000,
            0b00000000,
        ],
    ),
    (
        'u',
        [
            0b00000000, 0b01000100, 0b01000100, 0b01000100, 0b01000100, 0b01001100, 0b00110100,
            0b00000000,
        ],
    ),
    (
        'v',
        [
            0b00000000, 0b01000100, 0b01000100, 0b01000100, 0b00101000, 0b00101000, 0b00010000,
            0b00000000,
        ],
    ),
    (
        'w',
        [
            0b00000000, 0b01000100, 0b01000100, 0b01010100, 0b01010100, 0b01010100, 0b00101000,
            0b00000000,
        ],
    ),
    (
        'x',
        [
            0b00000000, 0b01000100, 0b00101000, 0b00010000, 0b00101000, 0b01000100, 0b01000100,
            0b00000000,
        ],
    ),
    (
        'y',
        [
            0b00000000, 0b01000100, 0b01000100, 0b00111100, 0b00000100, 0b01000100, 0b00111000,
            0b00000000,
        ],
    ),
    (
        'z',
        [
            0b00000000, 0b01111100, 0b00001000, 0b00010000, 0b00100000, 0b01000000, 0b01111100,
            0b00000000,
        ],
    ),
    (
        '0',
        [
            0b00111100, 0b01000110, 0b01001010, 0b01010010, 0b01100010, 0b01000010, 0b00111100,
            0b00000000,
        ],
    ),
    (
    ...
    (
        '9',
        [
            0b00111100, 0b01000010, 0b01000010, 0b00111110, 0b00000010, 0b01000010, 0b00111100,
            0b00000000,
        ],
    ),
    (
    ...
    (
        ':',
        [
            0b00000000, 0b00000000, 0b00011000, 0b00011000, 0b00000000, 0b00011000, 0b00011000,
            0b00000000,
        ],
    ),
    (
        ';',
        [
            0b00000000, 0b00000000, 0b00011000, 0b00011000, 0b00000000, 0b00011000, 0b00010000,
            0b00100000,
        ],
    ),
    (
    ...
    (
        '?',
        [
            0b00111100, 0b01000010, 0b00000010, 0b00001100, 0b00010000, 0b00000000, 0b00010000,
            0b00000000,
        ],
    ),
    (
        '@',
        [
            0b00111100, 0b01000010, 0b01011010, 0b01010110, 0b01011110, 0b01000000, 0b00111100,
            0b00000000,
        ],
    ),
    (
        '#',
        [
            0b00000000, 0b00101000, 0b01111100, 0b00101000, 0b00101000, 0b01111100, 0b00101000,
            0b00000000,
        ],
    ),
    (
    ...
    (
        '=',
        [
            0b00000000, 0b00000000, 0b00111100, 0b00000000, 0b00111100, 0b00000000, 0b00000000,
            0b00000000,
        ],
    ),
    (
    ...
    (
        '/',
        [
            0b00000010, 0b00000100, 0b00001000, 0b00010000, 0b00100000, 0b01000000, 0b00000000,
            0b00000000,
        ],
    ),
    (
        '*',
        [
            0b00000000, 0b01010100, 0b00111000, 0b01111100, 0b00111000, 0b01010100, 0b00000000,
            0b00000000,
        ],
    ),
    (
    ...
    (
        ']',
        [
            0b00110000, 0b00010000, 0b00010000, 0b00010000, 0b00010000, 0b00010000, 0b00110000,
            0b00000000,
        ],
    ),
    (
        '{',
        [
            0b00001000, 0b00010000, 0b00010000, 0b00100000, 0b00010000, 0b00010000, 0b00001000,
            0b00000000,
        ],
    ),
    (
    ...
    (
        '\\',
        [
            0b01000000, 0b00100000, 0b00010000, 0b00001000, 0b00000100, 0b00000010, 0b00000000,
            0b00000000,
        ],
    ),
    (
        '\"',
        [
            0b00101000, 0b00101000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000,
            0b00000000,
        ],
    ),
    (
    ...
    (
        '\'',
        [
            0b00010000, 0b00010000, 0b00010000, 0b00000000, 0b00000000, 0b00000000, 0b00000000,
            0b00000000,
        ],
    ),
    (
...
impl ModernRenderPipeline {
    ...
    fn render_layer_to_framebuffer(
        &self,
    ...
    fn blend_colors(&self, src: Color, dst: Color, blend_mode: BlendMode, alpha: f32) -> Color {
        match blend_mode {
            ...
            BlendMode::Alpha => {
                ...
                let r = ((src.r as f32 * src_alpha + dst.r as f32 * dst_alpha * (1.0 - src_alpha))
                    / final_alpha) as u8;
                let g = ((src.g as f32 * src_alpha + dst.g as f32 * dst_alpha * (1.0 - src_alpha))
                    / final_alpha) as u8;
                let b = ((src.b as f32 * src_alpha + dst.b as f32 * dst_alpha * (1.0 - src_alpha))
                    / final_alpha) as u8;
...
impl Color {
    ...
    pub fn from_pixel(pixel: u32, format: PixelFormat) -> Self {
        match format {
            ...
            PixelFormat::BGRA8888 => Self {
                r: (pixel & 0xFF) as u8,
                g: ((pixel >> 8) & 0xFF) as u8,
                b: ((pixel >> 16) & 0xFF) as u8,
                a: ((pixel >> 24) & 0xFF) as u8,
            },
            PixelFormat::RGB888 => Self {
                r: ((pixel >> 16) & 0xFF) as u8,
                g: ((pixel >> 8) & 0xFF) as u8,
                b: (pixel & 0xFF) as u8,
                a: 255,
            },
            PixelFormat::BGR888 => Self {
                r: (pixel & 0xFF) as u8,
                g: ((pixel >> 8) & 0xFF) as u8,
                b: ((pixel >> 16) & 0xFF) as u8,
                a: 255,
...
impl HardwareAccelerationManager {
    ...
    pub fn initialize_with_gpu(&mut self, gpu_info: &GpuInfo) -> Result<(), &'static str> {
        ...
        // Note: No podemos usar write_text_kernel aquí porque no tenemos acceso al framebuffer
        // En su lugar, usaremos un mecanismo de logging alternativo
        ...
        // Logging de éxito
        // Note: No podemos usar write_text_kernel aquí
...
impl Color {
    ...
    pub const DARKER_BLUE: Color = Color {
        r: 0,
        g: 0,
        b: 64,
        a: 255,
    ...
    pub const SEMI_TRANSPARENT_BLACK: Color = Color {
        r: 0,
        g: 0,
        b: 0,
        a: 128,
    };
    pub const SEMI_TRANSPARENT_WHITE: Color = Color {
        r: 255,
        g: 255,
        b: 255,
        a: 128,
...
impl FramebufferDriver {
    ...
    pub fn init_from_uefi(
        ...
        unsafe {
            ...
            if base_address >= 0x1000 && base_address < 0x100000000 {
                // Hasta 4GB
    ...
    pub fn init_hardware_acceleration(&mut self, gpu_info: &GpuInfo) -> Result<(), &'static str> {
        // Logging detallado para debugging
        self.write_text_kernel(
            "DEBUG: Iniciando hardware_acceleration.initialize_with_gpu",
            Color::YELLOW,
        );

        let result = self.hardware_acceleration.initialize_with_gpu(gpu_info);

        self.write_text_kernel(
            "DEBUG: hardware_acceleration.initialize_with_gpu completado",
            Color::YELLOW,
        );
    ...
    pub fn write_text_kernel(&mut self, text: &str, color: Color) {
        ...
        for &byte in text.as_bytes() {
            ...
            self.draw_character(x, y, byte as char, color);
            x += char_width;
        }
        y += char_height;
        // Actualizar posición para el siguiente texto
        self.current_y = y;
        self.current_x = x;
    }
    ...
    fn color_to_pixel(&self, color: Color) -> u32 {
        match self.info.pixel_format {
            ...
            _ => {
                // Por defecto o formato desconocido
    ...
    fn clear_region_fast(&mut self, x: u32, y: u32, width: u32, height: u32, color: Color) {
        ...
        for row in 0..height {
            let row_offset =
                start_offset + (row * self.info.pixels_per_scan_line * bytes_per_pixel as u32);
    ...
    pub fn clear_screen_fade(&mut self, color: Color, alpha: f32) {
        ...
        let fade_color = Color::rgba(color.r, color.g, color.b, (color.a as f32 * alpha) as u8);
    ...
    pub fn fill_rect_fast(&mut self, x: u32, y: u32, width: u32, height: u32, color: Color) {
        ...
        unsafe {
            for py in y..end_y {
                let row_start = self
                    .buffer
                    .offset((py * pitch + x * bytes_per_pixel as u32) as isize);
                ...
                match bytes_per_pixel {
                    ...
                    2 => {
                        ...
                        for px in x..end_x {
                            core::ptr::write_volatile(
                                row_start_16.offset((px - x) as isize),
                                pixel_16,
                            );
                        }
                    }
                    ...
                    4 => {
                        ...
                        for px in x..end_x {
                            core::ptr::write_volatile(
                                row_start_32.offset((px - x) as isize),
                                pixel_value,
                            );
                        }
                    }
    ...
    pub fn blit_fast(
        ...
        unsafe {
            for y in 0..actual_height {
                let src_row = src_fb
                    .buffer
                    .offset(((src_y + y) * src_pitch + src_x * bytes_per_pixel as u32) as isize);
                let dst_row = self
                    .buffer
                    .offset(((dst_y + y) * dst_pitch + dst_x * bytes_per_pixel as u32) as isize);
    ...
    pub fn blit(
        ...
        for y in 0..height {
            for x in 0..width {
                ...
                if src_px < src_fb.info.width
                    && src_py < src_fb.info.height
                    && dst_px < self.info.width
                    && dst_py < self.info.height
                {
...
impl HardwareAccelerated for FramebufferDriver {
    ...
    fn hardware_blit(
        ...
        match self.get_acceleration_type() {
            HardwareAcceleration::Intel2D => self.intel_hardware_blit(
                src_x, src_y, dst_x, dst_y, width, height, src_buffer, src_pitch,
            ),
            HardwareAcceleration::Nvidia2D => self.nvidia_hardware_blit(
                src_x, src_y, dst_x, dst_y, width, height, src_buffer, src_pitch,
            ),
            HardwareAcceleration::Amd2D => self.amd_hardware_blit(
                src_x, src_y, dst_x, dst_y, width, height, src_buffer, src_pitch,
            ),
    ...
    fn hardware_fill(
        ...
        match self.get_acceleration_type() {
            HardwareAcceleration::Intel2D => self.intel_hardware_fill(x, y, width, height, color),
            HardwareAcceleration::Nvidia2D => self.nvidia_hardware_fill(x, y, width, height, color),
            HardwareAcceleration::Amd2D => self.amd_hardware_fill(x, y, width, height, color),
            _ => Err("Unsupported acceleration type"),
        }
    }
    ...
    fn hardware_scale(
        ...
        match self.get_acceleration_type() {
            HardwareAcceleration::Intel2D => self.intel_hardware_scale(
                src_x, src_y, src_width, src_height, dst_x, dst_y, dst_width, dst_height,
            ),
            HardwareAcceleration::Nvidia2D => self.nvidia_hardware_scale(
                src_x, src_y, src_width, src_height, dst_x, dst_y, dst_width, dst_height,
            ),
            HardwareAcceleration::Amd2D => self.amd_hardware_scale(
                src_x, src_y, src_width, src_height, dst_x, dst_y, dst_width, dst_height,
            ),
            _ => Err("Unsupported acceleration type"),
        }
...
impl FramebufferDriver {
    ...
    fn intel_hardware_fill(
        ...
        unsafe {
            for y in 0..height {
                let row = self
                    .buffer
                    .offset(((y) * pitch + x * bytes_per_pixel as u32) as isize);
            ...
            for y in 0..height {
                for x_offset in 0..width {
                    let pixel_offset = self
                        .buffer
                        .offset(((y) * pitch + (x + x_offset) * bytes_per_pixel as u32) as isize);
    ...
    fn nvidia_hardware_alpha_blend(
        &mut self,
        x: u32,
        y: u32,
        width: u32,
...
pub fn get_framebuffer() -> Option<&'static mut FramebufferDriver> {
    unsafe { SYSTEM_FRAMEBUFFER.as_mut() }
}
...
pub fn is_framebuffer_available() -> bool {
    unsafe {
        SYSTEM_FRAMEBUFFER
            .as_ref()
            .map_or(false, |fb| fb.is_initialized())
    }
}

/// Obtener información del framebuffer
pub fn get_framebuffer_info() -> Option<FramebufferInfo> {
    unsafe { SYSTEM_FRAMEBUFFER.as_ref().map(|fb| fb.info) }
}
