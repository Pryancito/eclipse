...
impl ModularDriverManager {
    ...
    pub fn register_driver(
        &mut self,
        driver: &'static mut dyn ModularDriver,
    ) -> Result<(), DriverError> {
