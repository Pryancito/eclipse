...
impl ModularDriver for AudioModularDriver {
    ...
    fn get_info(&self) -> DriverInfo {
        ...
        match self.audio_type {
            ...
            AudioType::USB => {
                let _ = vendor.push_str("USB Audio Consortium");
            }
            AudioType::PCI => {
                let _ = vendor.push_str("PCI Audio Group");
            }
            AudioType::Generic => {
