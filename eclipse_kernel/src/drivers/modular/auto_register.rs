...
use super::{DriverError, ModularDriver, ModularDriverManager};
...
impl AutoDriverRegistrar {
    ...
    pub fn register_all_drivers(
        &mut self,
        manager: &mut ModularDriverManager,
...
pub fn get_registered_driver_count() -> usize {
    unsafe { AUTO_DRIVER_REGISTRAR.get_registered_count() }
}
