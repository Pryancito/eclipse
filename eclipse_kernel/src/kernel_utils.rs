...
use crate::plugins::{get_plugin_statistics, PluginInfo, PluginPriority, PluginType};
...
fn demonstrate_plugins_system() -> KernelResult<()> {
    ...
    match get_plugin_statistics() {
        Ok(stats) => {
            let msg1 = format!(
                "Estadísticas de plugins: {} total, {} cargados, {} ejecutándose",
...
pub fn check_kernel_health() -> KernelResult<KernelHealth> {
    ...
    match generate_metrics_report() {
        ...
        Err(_) => {
            ...
            health
                .errors
                .push("Sistema de métricas no disponible".to_string());
        }
    }
    ...
    match generate_config_report() {
        ...
        Err(_) => {
            ...
            health
                .errors
                .push("Sistema de configuración no disponible".to_string());
        }
    }
    ...
    match get_plugin_statistics() {
        ...
        Err(_) => {
            ...
            health
                .errors
                .push("Sistema de plugins no disponible".to_string());
        }
    }
