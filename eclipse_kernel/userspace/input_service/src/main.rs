...
pub extern "C" fn _start() -> ! {
    ...
    loop {
        ...
        // Process events from queue (simulate consumption) every ~1 s (500 × 2 ms)
        ...
        // Periodic status updates every ~30 s (15000 × 2 ms)
        if heartbeat_counter % 15000 == 0 {
        ...
        // Sleep 2 ms between polls for low-latency input handling
        sleep_ms(2);
    }
}
